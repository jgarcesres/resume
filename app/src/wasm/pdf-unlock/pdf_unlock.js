...
export class InspectResult {
     ...
     */
    get encrypted() {
        const ret = wasm.__wbg_get_inspectresult_encrypted(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {boolean}
     */
    get needsPassword() {
        const ret = wasm.__wbg_get_inspectresult_needsPassword(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @param {boolean} arg0
     */
    set encrypted(arg0) {
        wasm.__wbg_set_inspectresult_encrypted(this.__wbg_ptr, arg0);
    }
    /**
     * @param {boolean} arg0
     */
    set needsPassword(arg0) {
        wasm.__wbg_set_inspectresult_needsPassword(this.__wbg_ptr, arg0);
    }
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./pdf_unlock_bg.js": import0,
    };
}

const InspectResultFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_inspectresult_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('pdf_unlock_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
